            ...
            {step === "payment" && (
              <div className="space-y-6 animate-fade-in-up">
                ...
                <div className="space-y-4">
                  {/* Payment Options */}
                  <label className="flex items-center gap-4 p-4 rounded-xl border-2 cursor-pointer transition-all" style={{ borderColor: "var(--color-forest-600)", background: "var(--color-forest-50)" }}>
                    <input type="radio" name="payment_method" defaultChecked className="w-5 h-5 text-forest-600 focus:ring-forest-500" />
                  ...
                  <label className="flex items-center gap-4 p-4 rounded-xl border cursor-pointer transition-all hover:bg-stone-50" style={{ borderColor: "var(--color-stone-200)", background: "white" }}>
                    <input type="radio" name="payment_method" className="w-5 h-5 text-forest-600 focus:ring-forest-500" />
                    <div className="flex-1">
                ...
                {/* Card Details Mockup */}
                <div className="p-6 rounded-xl border mt-6" style={{ background: "white", borderColor: "var(--color-stone-200)" }}>
                  <div className="space-y-5">
                    <div>
                      <label className="block text-sm font-medium mb-1.5" style={{ color: "var(--color-stone-700)" }}>Card Number</label>
                      <input type="text" placeholder="0000 0000 0000 0000" className="w-full px-4 py-3 rounded-xl border focus:ring-2 focus:ring-forest-200 outline-none transition-all" style={{ background: "var(--color-cream-50)", borderColor: "var(--color-stone-200)" }} />
                    </div>
                    <div className="grid grid-cols-2 gap-5">
                      <div>
                        <label className="block text-sm font-medium mb-1.5" style={{ color: "var(--color-stone-700)" }}>Expiry Date</label>
                        <input type="text" placeholder="MM/YY" className="w-full px-4 py-3 rounded-xl border focus:ring-2 focus:ring-forest-200 outline-none transition-all" style={{ background: "var(--color-cream-50)", borderColor: "var(--color-stone-200)" }} />
                      </div>
                      <div>
                        <label className="block text-sm font-medium mb-1.5" style={{ color: "var(--color-stone-700)" }}>CVC</label>
                        <input type="text" placeholder="123" className="w-full px-4 py-3 rounded-xl border focus:ring-2 focus:ring-forest-200 outline-none transition-all" style={{ background: "var(--color-cream-50)", borderColor: "var(--color-stone-200)" }} />
                      </div>
                    </div>
                  </div>
                </div>
