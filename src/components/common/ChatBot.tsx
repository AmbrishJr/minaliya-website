  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`px-4 py-2.5 rounded-2xl bg-white border border-stone-200 text-stone-800 text-xs sm:text-sm font-semibold shadow-xl flex items-center gap-2 pointer-events-auto transition-all duration-500 origin-right max-w-[200px] sm:max-w-none ${showTooltip
