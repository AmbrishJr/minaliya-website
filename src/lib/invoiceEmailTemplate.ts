    ...
    .map((item, i) => {
      ...
      return `
        <tr>
          ...
          <td style="padding:14px 12px;border-bottom:1px solid #e8e5e0;font-size:13px;font-weight:600;color:#1c1917;">${item.productName}</td>
                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center">
                      <tr>
                        <td style="padding-right:12px;">
                          <!--[if mso]>
                          <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${data.invoiceDownloadUrl}" style="height:48px;v-text-anchor:middle;width:200px;" arcsize="17%" stroke="f" fillcolor="#7c3aed">
                            <w:anchorlock/>
                            <center>
                          <![endif]-->
                          <a href="${data.invoiceDownloadUrl}" style="display:inline-block;background-color:#7c3aed;color:#ffffff;text-decoration:none;font-size:14px;font-weight:600;padding:14px 28px;border-radius:8px;letter-spacing:0.5px;mso-padding-alt:0;text-underline-color:#7c3aed;">Download Invoice</a>
                          <!--[if mso]>
                            </center>
                          </v:roundrect>
                          <![endif]-->
                        ...
                        <td>
                          <!--[if mso]>
                          <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${data.ordersPageUrl}" style="height:48px;v-text-anchor:middle;width:200px;" arcsize="17%" stroke="f" fillcolor="#2d3e2f">
                            <w:anchorlock/>
                            <center>
                          <![endif]-->
                          <a href="${data.ordersPageUrl}" style="display:inline-block;background-color:#2d3e2f;color:#ffffff;text-decoration:none;font-size:14px;font-weight:600;padding:14px 28px;border-radius:8px;letter-spacing:0.5px;mso-padding-alt:0;text-underline-color:#2d3e2f;">View My Orders</a>
                          <!--[if mso]>
                            </center>
                          </v:roundrect>
                          <![endif]-->
